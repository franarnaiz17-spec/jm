document.addEventListener('DOMContentLoaded', () => {
    ...
    if (menuToggle && listas) {
        ...
        // Útil para que cuando el usuario elija una sección, el menú desaparezca
...
// Estas funciones se mantienen fuera para que el "onclick" del HTML pueda encontrarlas
